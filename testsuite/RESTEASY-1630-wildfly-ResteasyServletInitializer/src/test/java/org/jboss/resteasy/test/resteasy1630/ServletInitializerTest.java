...
///import org.jboss.resteasy.test.resteasy1630.TestApplication;
...
public class ServletInitializerTest {
    ...
    public static Archive<?> createTestArchive() {
        WebArchive war = ShrinkWrap.create(WebArchive.class, "RESTEASY-1630-two.war")
            ...
            .addAsWebInfResource("resteasy-servlet-initializer-3.1.3-SNAPSHOT.jar", "lib/resteasy-servlet-initializer-3.1.3-SNAPSHOT.jar")
