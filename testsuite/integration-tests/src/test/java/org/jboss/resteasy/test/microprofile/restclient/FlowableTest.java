...
import org.jboss.resteasy.test.microprofile.restclient.resource.FlowableResourceService;
import org.jboss.resteasy.test.microprofile.restclient.resource.FlowableResourceServiceIntf;
...
public class FlowableTest {
   ...
   private static FlowableResourceServiceIntf flowableResourceServiceIntf;
   private static CountDownLatch latch;
   private static AtomicInteger errors;

   private static final String WAR_SERVICE = FlowableTest.class.getSimpleName();
   ...
   public static Archive<?> deploy() {
      ...
      war.addClass(FlowableResourceService.class);
   ...
   public static void beforeClass() throws Exception {
      ...
      flowableResourceServiceIntf = builder
              .baseUri(URI.create(generateURL("", WAR_SERVICE)))
              .build(FlowableResourceServiceIntf.class);
   }
   ...
   public void testGet() throws Exception {
      Flowable<String> flowable = flowableResourceServiceIntf.get();
      flowable.subscribe(
   ...
   public void testGetThing() throws Exception {
      Flowable<Thing> flowable = flowableResourceServiceIntf.getThing();
      flowable.subscribe(
   ...
   public void testGetThingList() throws Exception {
      Flowable<List<Thing>> flowable = flowableResourceServiceIntf.getThingList();
      flowable.subscribe(
   ...
   public void testGetBytes() throws Exception {
      Flowable<byte[]> flowable = flowableResourceServiceIntf.getBytes();
      flowable.subscribe(
